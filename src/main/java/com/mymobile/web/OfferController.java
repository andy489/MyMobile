...
import com.mymobile.model.dto.OfferSearchDto;
import com.mymobile.service.BrandService;
import com.mymobile.service.OfferService;
...
public class OfferController extends GenericController {
    ...
    @PreAuthorize("@offerService.isOwner(#id, principal.username)")
    @DeleteMapping("/{id}")
